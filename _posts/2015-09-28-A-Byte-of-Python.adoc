...
* Arguments must be assigned a value when being called if the parameters are not given a default value.
* Only those parameters which are at the *end of the parameter list* can be given default argument values.
* If you want to assign values to the variables, you don't have to specify them in the same order of the parameters list of the function definition
* Variables without default values could also be assigned in the same way as the variables with default value.
